...
//             <Package className="w-8 h-8 md:w-10 md:h-10 text-red-600" />
//           </div>
...
//           <Link 
//             to="/products"
//             className="inline-block bg-sacred-crimson text-white px-6 py-3 rounded-lg font-medium hover:bg-red-700 transition-colors"
//           >
//             Browse Products
//           </Link>
//         </div>
...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-rose-50 to-red-50 py-4 md:py-8">
...
//             <span className="ml-1 md:ml-2 font-bold text-sacred-crimson text-xs md:text-sm">{orderId}</span>
//           </div>
//         </div>
...
//                 <ShoppingBag className="w-5 h-5 md:w-6 md:h-6 mr-2 text-sacred-crimson" />
//                 Order Summary
//               </h2>
...
//                   return (
//                     <div key={index} className="flex items-center justify-between p-3 md:p-4 bg-rose-50 rounded-lg">
...
//                         <IndianRupee className="w-3 h-3 md:w-4 md:h-4 text-sacred-crimson" />
//                         <span className="font-bold text-sacred-crimson text-sm md:text-base">
...
//                   <div className="flex items-center text-lg md:text-xl font-bold text-sacred-crimson">
...
//             {/* Delivery Status */}
//             <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border border-rose-100">
//               <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-3 md:mb-4 flex items-center">
//                 <Truck className="w-5 h-5 md:w-6 md:h-6 mr-2 text-sacred-crimson" />
//                 Delivery Status
//               </h2>
...
//               </div>
//               <div className="flex items-center">
//                 <div className="w-8 h-8 md:w-10 md:h-10 bg-rose-100 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
...
//                     className="hover:text-rose-600 transition-colors duration-200 truncate"
//                   >
...
//                   className="w-full bg-sacred-crimson text-white py-2 md:py-3 rounded-lg md:rounded-xl font-medium hover:bg-red-700 transition-colors text-sm md:text-base"
//                 >
//                   Continue Shopping
//                 </button>
//                 <button 
//                   onClick={() => navigate('/')}
//                   className="w-full border border-sacred-crimson text-sacred-crimson py-2 md:py-3 rounded-lg md:rounded-xl font-medium hover:bg-rose-50 transition-colors flex items-center justify-center text-sm md:text-base"
//                 >
...
//         {/* Order Note */}
//         <div className="mt-6 md:mt-8 bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border border-rose-100 text-center">
//           <p className="text-gray-600 text-sm md:text-base">
//             A confirmation email has been sent to your email address with your order details. 
//             Please keep this order ID for reference: <span className="font-medium text-sacred-crimson">{orderId}</span>
//           </p>
//         </div>
//       </div>
//     </div>

...
// const resend = new Resend("re_CYiJApEC_8xK7fJvpyx6oZs8bDWYqfeJb");
...
//     // Email to Admin (Your Team)
//     const clientMail = {
//       from: 'Adiyogi Foundation <onboarding@resend.dev>',
//       to: 'join.adiyogifoundation@gmail.com',
//       subject: 'New Contact Form Submission',
//       html: `
//         <h3>New Contact Message</h3>
...
//     await resend.emails.send(clientMail);
...
// // Hardcode your API key as a string
...
export const addContact = async (req, res) => {
  try {
    ...
    //          <p>Warm regards,<br/>Team Adiyogi Foundation</p></div>`
    // };

    // // Send emails via Resend
    // await resend.emails.send(clientMail);
    // await resend.emails.send(userMail);
  const newContact = new Contact({ name, phone, email, city, message });
  await newContact.save();
    return res.status(201).json({ message: "Message sent successfully", success: true,newContact

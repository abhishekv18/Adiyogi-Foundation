...
//   <title>Adiyogi Foundation | Rebuilding Purpose. Restoring Dharma.</title>
//   <meta name="description" content="Adiyogi Foundation is a spiritual and cultural movement committed to restoring Sanatana Dharma, reviving ancient wisdom, and guiding humanity towards peace and purpose." />
//   <meta name="keywords" content="Adiyogi Foundation, Sanatana Dharma, Yoga, Spirituality, Indian Culture, Meditation, Dharma Revival, Inner Peace, Ancient Wisdom" />
//   <link rel="canonical" href="https://www.adiyogifoundation.org.in/" />
 ...
 const user = useSelector((state) => state.auth.user);
  ...
  const impactStats = [
    { 
      number: '10,00+', 
      label: 'Trees Planted',
      icon: <TreePine className="w-8 h-8 text-[#6a0dad]" />,
      description: 'Native species across 15 states'
    },
    { 
      number: '50+', 
      label: 'Children Educated',
      icon: <GraduationCap className="w-8 h-8 text-[#5a0ba5]" />,
      description: 'Free quality education provided'
    },
    { 
      number: '2+', 
      label: 'Sacred Sites Restored',
      icon: <BookTemplate className="w-8 h-8 text-[#6a0dad]" />,
      description: 'Temples and heritage sites revived'
    },
    { 
      number: '20+', 
      label: 'Active Volunteers',
      icon: <Users className="w-8 h-8 text-[#5a0ba5]" />,
      description: 'Dedicated seva warriors'
    }
  ];

  const coreValues = [
    { name: 'Dharma', icon: <Shield className="w-5 h-5" />, color: 'bg-[#6a0dad]' },
    { name: 'Dignity', icon: <Crown className="w-5 h-5" />, color: 'bg-[#5a0ba5]' },
    { name: 'Service', icon: <Heart className="w-5 h-5" />, color: 'bg-[#6a0dad]' },
    { name: 'Sustainability', icon: <Leaf className="w-5 h-5" />, color: 'bg-[#5a0ba5]' },
    { name: 'Synchronicity', icon: <Star className="w-5 h-5" />, color: 'bg-[#6a0dad]' }
  ];
  ...
  <meta name="twitter:image:alt" content="Adiyogi Foundation Twitter Image" />
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#FFFFFF] to-[#FFFEF7]">
      {/* Hero Section */}
      <Hero />
      ...
      <section className="py-12 md:py-16 bg-gradient-to-r from-[#2C2C2C] to-[#2C2C2C] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
          <div className="mb-4 md:mb-6">
            <Sun className="w-12 h-12 md:w-16 md:h-16 text-[#6a0dad] mx-auto mb-4 opacity-80" />
          </div>
          <blockquote className="text-xl md:text-2xl lg:text-3xl text-[#FFFEF7] font-light italic leading-relaxed mb-4 md:mb-6">
            "यत्र योगेश्वरः कृष्णो यत्र पार्थो धनुर्धरः।<br />
            तत्र श्रीर्विजयो भूतिर्ध्रुवा नीतिर्मतिर्मम॥"
          </blockquote>
          <p className="text-[#6a0dad] text-base md:text-lg">
            Where there is Krishna and Arjuna, there is prosperity, victory, and eternal dharma.
          </p>
        </div>
      </section>
      ...
      {/* Transformation Journey */}
      <section className="py-12 md:py-20 bg-[#FFFFFF] relative">
        <div className="absolute inset-0 bg-gradient-to-br from-[#6a0dad]/5 to-[#5a0ba5]/5"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-8 md:mb-16">
            <div className="flex justify-center mb-4 md:mb-6">
              <Flower className="w-10 h-10 md:w-12 md:h-12 text-[#6a0dad] animate-pulse" />
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#2C2C2C] mb-4 md:mb-6">
              The Path of <span className="text-[#6a0dad]">Transformation</span>
            </h2>
            <p className="text-xl md:text-2xl text-[#2C2C2C] max-w-4xl mx-auto font-light leading-relaxed">
              "We do not build temples; we rebuild purpose and restore lives through the eternal wisdom of dharma."
            </p>
  ...
  {transformationPath.map((path, index) => (
    <div key={index} className="relative group h-full">
      <div className="flex flex-col justify-between h-full bg-[#FFFEF7] p-6 md:p-7 rounded-2xl shadow-xl border border-[#F0E6FF] hover:border-[#6a0dad] transition-all duration-500 hover:shadow-2xl transform hover:-translate-y-2">
        
        {/* Top Circle */}
        <div className="text-center mb-4 md:mb-6">
          <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#FFFFFF] to-[#F8F0FF] rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            <span className="text-[#6a0dad] text-sm md:text-base font-bold">{path.from}</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center mb-4 md:mb-6">
          <div className="flex items-center space-x-2 md:space-x-3 mb-2 md:mb-4">
            <div className="text-[#6a0dad]">{path.icon}</div>
            <span className="text-[#6a0dad] font-semibold text-base md:text-lg">{path.via}</span>
          </div>
          <div className="w-1 h-6 md:h-8 bg-gradient-to-b from-[#6a0dad] to-transparent mb-2 md:mb-4"></div>
          <ArrowRight className="text-[#6a0dad] transform rotate-90" size={20} />
        </div>
        
        {/* Bottom Circle */}
        <div className="text-center mb-4 md:mb-6">
          <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#6a0dad] to-[#5a0ba5] rounded-full flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
            <span className="text-[#FFFEF7] text-sm md:text-base font-bold">{path.to}</span>
          </div>
        </div>
        ...
        <p className="text-[#2C2C2C]/70 text-center leading-relaxed text-sm md:text-base">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="bg-[#FFFEF7] p-6 md:p-10 rounded-2xl shadow-xl border border-[#F0E6FF] relative overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-[#6a0dad]/10 to-transparent rounded-bl-full"></div>
                <div className="relative z-10">
                  <div className="flex items-center mb-4 md:mb-6">
                    <EyeIcon className="w-6 h-6 md:w-8 md:h-8 text-[#6a0dad] mr-2 md:mr-3" />
                    <h3 className="text-xl md:text-2xl font-bold text-[#6a0dad]">We Believe</h3>
                  </div>
                  <div className="space-y-3 md:space-y-4">
                    <div className="flex items-start group">
                      <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#6a0dad] rounded-full mt-2 md:mt-3 mr-2 md:mr-4 group-hover:scale-150 transition-transform duration-300"></div>
                      <p className="text-[#2C2C2C] leading-relaxed text-sm md:text-base">Spirituality is not an escape, but an anchor that grounds us in truth and purpose.</p>
                    </div>
                    <div className="flex items-start group">
                      <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#6a0dad] rounded-full mt-2 md:mt-3 mr-2 md:mr-4 group-hover:scale-150 transition-transform duration-300"></div>
              ...
              <div className="bg-[#FFFEF7] p-6 md:p-10 rounded-2xl shadow-xl border border-[#F0E6FF] relative overflow-hidden">
                <div className="absolute bottom-0 left-0 w-24 h-24 md:w-32 md:h-32 bg-gradient-to-tr from-[#6a0dad]/10 to-transparent rounded-tr-full"></div>
                <div className="relative z-10">
                  <div className="flex items-center mb-4 md:mb-6">
                    <Globe className="w-6 h-6 md:w-8 md:h-8 text-[#6a0dad] mr-2 md:mr-3" />
                    <h3 className="text-xl md:text-2xl font-bold text-[#6a0dad]">Our Vision</h3>
                  </div>
                  <div className="space-y-3 md:space-y-4">
                    <div className="flex items-start group">
                      <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#6a0dad] rounded-full mt-2 md:mt-3 mr-2 md:mr-4 group-hover:scale-150 transition-transform duration-300"></div>
      ...
      <section className="py-8 md:py-12 bg-gradient-to-br from-[#FFFFFF] via-[#FFFEF7] to-[#FFFFFF] relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-10 md:top-20 left-4 md:left-10 w-16 md:w-32 h-16 md:h-32 bg-[#6a0dad]/5 rounded-full blur-xl md:blur-3xl"></div>
        <div className="absolute bottom-10 md:bottom-20 right-4 md:right-10 w-20 md:w-40 h-20 md:h-40 bg-[#5a0ba5]/5 rounded-full blur-xl md:blur-3xl"></div>
        <div className="absolute top-1/2 left-1/3 w-12 md:w-24 h-12 md:h-24 bg-[#6a0dad]/3 rounded-full blur-xl md:blur-2xl"></div>
      </div>
      
      <div className="absolute inset-0 opacity-30">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 1px 1px, rgba(106, 13, 173, 0.1) 1px, transparent 0)`,
          backgroundSize: '20px 20px'
        }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-5 relative z-10">
        ...
        <div className="relative mb-8 md:mb-12">
          {/* Top Banner */}
          <div className="text-center mb-6 md:mb-8">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#6a0dad]/10 to-[#5a0ba5]/10 backdrop-blur-sm px-4 py-2 md:py-3 md:px-5 rounded-full border border-[#6a0dad]/20 mb-4">
              <Sparkles className="w-4 h-4 text-[#6a0dad]" />
              <span className="text-sm font-semibold text-[#6a0dad]">Sacred Service Programs</span>
              <Star className="w-4 h-4 text-[#6a0dad]" />
            </div>
          </div>
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="flex justify-center mb-6 md:mb-8">
              <div className="relative">
                <div className="absolute inset-0 bg-[#6a0dad]/20 rounded-full blur-lg md:blur-xl scale-125 md:scale-150"></div>
                <div className="relative bg-gradient-to-br from-[#6a0dad] to-[#5a0ba5] p-3 md:p-4 rounded-full shadow-xl md:shadow-2xl">
                  <Flower className="w-8 h-8 md:w-12 md:h-12 text-white" />
                </div>
              </div>
            </div>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-[#2C2C2C] mb-6 md:mb-8 tracking-tight">
              Our <span className="bg-gradient-to-r from-[#6a0dad] to-[#5a0ba5] bg-clip-text text-transparent">Programs</span>
            </h2>
            <div className="w-16 md:w-24 h-0.5 md:h-1 bg-gradient-to-r from-[#6a0dad] to-[#5a0ba5] mx-auto mb-6 md:mb-8 rounded-full"></div>
            <p className="text-lg md:text-xl font-semibold text-[#2C2C2C] max-w-4xl mx-auto leading-relaxed opacity-90">
              Our Seva is sacred it manifests through transformative programs that merge ancient dharma with practical service to uplift life and spirit.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {programs.map((prog, i) => (
            <div
              ...
              className="cursor-pointer group relative overflow-hidden"
            >
              <div className="relative p-6 md:p-8 bg-white/80 backdrop-blur-sm border border-[#F0E6FF]/60 hover:border-[#6a0dad]/40 rounded-2xl md:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group-hover:bg-white/90">
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFFEF7]/50 to-transparent rounded-2xl md:rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="relative mb-4 md:mb-6">
                  ...
                  <div className="absolute -top-1 -right-1 w-4 h-4 md:w-6 md:h-6 bg-[#6a0dad]/20 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-125"></div>
                </div>
                
                <div className="relative z-10">
                  <h3 className="text-lg md:text-xl font-bold text-[#2C2C2C] group-hover:text-[#6a0dad] mb-2 transition-colors duration-300">
                    {prog.title}
                  </h3>
                  <p className="text-[#6a0dad] font-semibold mb-3 md:mb-4 opacity-90 text-sm md:text-base">{prog.subtitle}</p>
                  
                  <ul className="text-xs md:text-sm text-[#2C2C2C]/80 space-y-1 md:space-y-2 mb-4 md:mb-6">
                    {prog.highlights.map((point, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <div className="w-1 h-1 md:w-1.5 md:h-1.5 bg-[#6a0dad] rounded-full mt-1.5 md:mt-2 flex-shrink-0"></div>
                        <span className="leading-relaxed">{point}</span>
                      </li>
                    ))}
                  </ul>
                  
                  <div className="flex items-center gap-1 md:gap-2 text-[#6a0dad] text-xs md:text-sm font-semibold group-hover:gap-2 md:group-hover:gap-3 transition-all duration-300">
                    <span>Learn more</span>
                    <ArrowRight className="w-4 h-4 text-[#6a0dad] group-hover:translate-x-1 transition-transform duration-300" />
                  </div>
                </div>
                
                <div className="absolute inset-0 rounded-2xl md:rounded-3xl bg-gradient-to-br from-[#6a0dad]/20 via-transparent to-[#5a0ba5]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-lg md:blur-xl transform scale-105"></div>
              </div>
            </div>
          ))}
        </div>
          ...
          {activeIndex !== null && (
            ...
            >
              <motion.div
                ...
                exit={{ y: 60, scale: 0.9, opacity: 0 }}
                transition={{ duration: 0.4, ease: "easeOut" }}
                className="bg-gradient-to-br from-[#FFFEF7] to-[#FFFFFF] max-w-lg w-full rounded-2xl md:rounded-3xl p-6 md:p-8 relative shadow-2xl border border-[#F0E6FF]/50"
                onClick={(e) => e.stopPropagation()}
              >
                <button
                  onClick={() => setActiveIndex(null)}
                  className="absolute top-4 md:top-6 right-4 md:right-6 w-8 h-8 md:w-10 md:h-10 bg-[#5a0ba5]/10 hover:bg-[#6a0dad]/20 rounded-full flex items-center justify-center text-[#5a0ba5] hover:text-[#6a0dad] transition-all duration-300 hover:scale-110"
                >
                  <X size={16} />
                </button>
                
                <div className="pr-4 md:pr-6">
                  <h3 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-[#6a0dad] to-[#5a0ba5] bg-clip-text text-transparent mb-2 md:mb-3">
                    {programs[activeIndex].title}
                  </h3>
                  <p className="text-[#2C2C2C] mb-4 md:mb-6 font-semibold text-base md:text-lg opacity-90">
                    {programs[activeIndex].subtitle}
                  </p>
                  <div className="w-12 md:w-16 h-0.5 bg-gradient-to-r from-[#6a0dad] to-[#5a0ba5] mb-4 md:mb-6 rounded-full"></div>
                  <p className="text-[#2C2C2C] leading-relaxed whitespace-pre-line opacity-90 text-sm md:text-base">
                    {programs[activeIndex].fullDescription}
                  </p>
                </div>
                
                <div className="absolute bottom-0 right-0 w-24 h-24 md:w-32 md:h-32 bg-gradient-to-tl from-[#6a0dad]/5 to-transparent rounded-full -z-10"></div>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
...
<section className="py-12 md:py-20 relative overflow-hidden bg-gradient-to-br from-[#FFFFFF] to-[#FFFEF7]">
  <div className="absolute inset-0 bg-[url('/WhatsApp%20Image%202025-07-26%20at%2022.16.55_306c1710.jpg')] bg-cover bg-center opacity-40 mix-blend-multiply"></div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
    <div className="text-center mb-8 md:mb-16">
      <div className="flex justify-center mb-4 md:mb-6">
        <Award className="w-10 h-10 md:w-12 md:h-12 text-[#6a0dad]" />
      </div>
      <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#2C2C2C] mb-4 md:mb-6">
        Our <span className="text-[#6a0dad]">Impact</span>
      </h2>
      <p className="text-lg md:text-xl font-semibold text-[#2C2C2C]">Making a difference, one step at a time.</p>
    </div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
      {impactStats.map((stat, index) => (
        <div key={index} className="flex flex-col h-full">
          <div className="flex flex-col justify-center items-center flex-grow bg-[#FFFEF7] p-4 md:p-8 rounded-lg md:rounded-xl shadow-lg border border-[#F0E6FF] hover:border-[#6a0dad] transition-all duration-300 hover:shadow-2xl h-full text-center">
            <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#6a0dad] mb-1 md:mb-2">{stat.number}</div>
            <div className="text-sm md:text-base text-[#2C2C2C] font-semibold">{stat.label}</div>
          </div>
        </div>
      ))}
      ...
      <section className="py-12 md:py-20 bg-[#FFFEF7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#2C2C2C] mb-4 md:mb-6">
            We're not <span className="text-[#6a0dad]">hiring</span>, we're <span className="text-[#6a0dad]">inviting</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
            <Link to="/contact" className="bg-gradient-to-r from-[#6a0dad] to-[#5a0ba5] text-[#FFFEF7] px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:from-[#5a0ba5] hover:to-[#6a0dad] transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2">
              <MessageCircle size={16} />
              <span>Join Our Community</span>
            </Link>
            <Link to="/volunteers" className="border-2 border-[#6a0dad] text-[#6a0dad] px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-gradient-to-r from-[#6a0dad] to-[#5a0ba5] hover:text-[#FFFEF7] transition-all duration-300 flex items-center justify-center space-x-2">
              <Users size={16} />
              <span>Volunteer with Us</span>
            </Link>
          </div>
          
          <div className="bg-gradient-to-r from-[#FFFFFF] to-[#FFFEF7] p-6 md:p-8 rounded-xl shadow-lg border border-[#F0E6FF]">
            <h3 className="text-xl md:text-2xl font-bold text-[#2C2C2C] mb-3 md:mb-4">Core Values</h3>
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-4 md:mb-6">
              {Array.isArray(coreValues) &&
                coreValues.map((value, index) =>
                  typeof value === 'object' && value.name && value.name.trim() !== '' ? (
                    <span
                      key={index}
                      className="px-3 py-1 md:px-4 md:py-2 bg-[#6a0dad] text-[#FFFEF7] rounded-full font-medium text-sm md:text-base"
                    >
                      {value.name}
                    </span>
                  ) : null

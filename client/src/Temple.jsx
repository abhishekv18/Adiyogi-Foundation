                ...
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/2 relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="flex items-center text-white">
                        <MapPin className="w-4 h-4 mr-2" />
                        <span className="text-xs sm:text-sm font-medium">{temple.location}</span>
                      </div>
                    </div>
                  </div>
                  <div className="lg:w-1/2 p-6 sm:p-8 lg:p-10 xl:p-12">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 sm:mb-6">
                      <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold pr-4 mb-2 sm:mb-0" style={{ color: '#2C2C2C' }}>
                        {temple.name}
                      </h4>
                      <span 
                        className="px-3 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold text-white whitespace-nowrap"
                        style={{ backgroundColor: temple.status === 'Launching Soon' ? '#8B1538' : '#C41E3A' }}
                      >
                        {temple.status}
                      </span>
                    ...
                    <p className="mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed" style={{ color: '#2C2C2C' }}>
                      {temple.description}
                    </p>

                    <div className="mb-6 sm:mb-8">
                      <div className="flex justify-between items-center mb-2 sm:mb-3">
                        <span className="font-semibold text-sm sm:text-base" style={{ color: '#2C2C2C' }}>
                          Restoration Progress
                        </span>
                        <div className="flex items-center">
                          ...
                          <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: temple.progress > 20 ? '#C41E3A' : '#F4E8E8' }} />
                        </div>
                      </div>
                    ...
                    >
                      ...
                      {expandedTemple === index ? 
                        <ChevronUp className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#C41E3A' }} /> : 
                        <ChevronDown className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#C41E3A' }} />
                      }
                    </button>
                    ...
                    {expandedTemple === index && (
                      <div className="mt-4 sm:mt-6 space-y-4 sm:space-y-6">
                        <div className="p-4 sm:p-6 rounded-lg" style={{ backgroundColor: '#F4E8E8' }}>
                          <h5 className="font-bold text-lg sm:text-xl mb-2 sm:mb-3" style={{ color: '#2C2C2C' }}>
                            Historical Significance
                          </h5>
                          <p className="mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base" style={{ color: '#2C2C2C' }}>
                            {temple.historicalRelevance}
                          </p>
                          
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                            <div>
                              <h6 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2" style={{ color: '#8B1538' }}>
                                Funding Needed
                              </h6>
                              <p className="text-base sm:text-lg font-bold" style={{ color: '#C41E3A' }}>
                                {temple.fundingNeeded}
                              </p>
                            </div>
                            <div>
                          ...
                          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <button
                              className="flex-1 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-white text-sm sm:text-base transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1"
                              style={{ 
                                backgroundColor: '#8B1538',
                                boxShadow: '0 4px 16px rgba(139, 21, 56, 0.25)'
                              }}
                            ...
                            <button
                              className="flex-1 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold border-2 text-sm sm:text-base transition-all duration-300 hover:shadow-md"
                              style={{ 
                                borderColor: '#C41E3A',
                                color: '#C41E3A',
                                backgroundColor: 'transparent'

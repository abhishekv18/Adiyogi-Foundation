  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* <div className="bg-gradient-to-br from-purple-900 to-purple-800 text-white py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2">
                  <Flame className="w-6 h-6 text-white animate-pulse" />
                  <Package className="w-6 h-6 text-white" />
                  <Flower className="w-6 h-6 text-white animate-pulse" style={{ animationDelay: '1s' }} />
                </div>
              </div>
              
              <h1 className="text-3xl md:text-4xl font-bold mb-3">
                Sacred <span className="text-[#b784f6]">Products</span>
              </h1>
              
              <p className="text-purple-100 max-w-2xl mx-auto text-sm md:text-base">
                Discover spiritual tools, sacred items, and divine offerings for your journey
              </p>
              
              <div className="flex justify-center items-center space-x-3 mt-4">
                <div className="w-12 h-1 bg-[#6a0dad] rounded-full"></div>
                <Sparkles className="w-5 h-5 text-[#6a0dad]" />
                <div className="w-12 h-1 bg-[#6a0dad] rounded-full"></div>
              </div>
            </div>
          </div>
        </div> */}
<div className="relative bg-gradient-to-br from-purple-900/90 to-purple-800/90 text-white py-12 overflow-hidden">
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-br from-purple-900/80 to-purple-800/70"></div>
  </div>
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
    <div className="text-center">
      <div className="flex justify-center mb-4">
        <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 border border-white/20">
          <Flame className="w-6 h-6 text-white animate-pulse" />
          <Package className="w-6 h-6 text-white" />
          <Flower className="w-6 h-6 text-white animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
      ...
      <div className="flex justify-center items-center space-x-3 mt-4">
        <div className="w-12 h-1 bg-[#b784f6] rounded-full"></div>
        <Sparkles className="w-5 h-5 text-[#b784f6]" />
        <div className="w-12 h-1 bg-[#b784f6] rounded-full"></div>
      </div>
    </div>
  </div>
        ...
        {/* Products Section - Now Appears Much Higher */}
            ...
            <>
              ...
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-gray-800">
                  {filteredProducts.length} Sacred Product{filteredProducts.length !== 1 ? 's' : ''} Available
                </h2>

...
const AdminLoginPage = () => {
  ...
  >
    ...
    <div className="min-w-0 flex-1">
      <div className="flex flex-col sm:flex-row sm:items-baseline sm:space-x-1">
           ...
           <h1 className="text-sm sm:text-lg lg:text-2xl font-bold text-[#6a0dad] group-hover:text-[#ff00ff] transition-colors duration-300 truncate leading-tight">
      Adiyogi
    </h1>
    <h2 className="text-xs sm:text-base lg:text-2xl font-bold text-[#6a0dad] group-hover:text-[#ff00ff] transition-colors duration-300 truncate leading-tight">
     Foundation
    </h2>
      </div>
    ...
    Rebuilding Purpose. Restoring Dharma.
            ...
            <Link to='/'>
              <button className="flex items-center space-x-2 text-gray-600 hover:text-[#6a0dad] transition-colors">
                <Home className="h-4 w-4" />
                <span className="text-sm">Home</span>
              </button>
            </Link>
      ...
      <div className="flex min-h-[calc(100vh-4rem)] pt-20">
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#6a0dad] to-[#ff00ff] relative overflow-hidden">
          <div className="absolute inset-0 bg-black bg-opacity-20"></div>
          <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
           <div className="max-w-md text-center">
  <div className="mb-8">
  ...
  <div className="space-y-4 text-left">
    <div className="flex items-center space-x-3 bg-white bg-opacity-10 p-4 rounded-lg backdrop-blur-sm">
      ...
      <div>
        <h3 className="font-semibold">Content Management</h3>
        <p className="text-sm text-purple-100">Create, edit, and publish spiritual blogs and updates</p>
      </div>
    </div>
    ...
    <div className="flex items-center space-x-3 bg-white bg-opacity-10 p-4 rounded-lg backdrop-blur-sm">
      ...
      <div>
        <h3 className="font-semibold">Community Engagement</h3>
        <p className="text-sm text-purple-100">Inspire and connect with seekers through shared wisdom</p>
      </div>
    </div>
  </div>
</div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#6a0dad] to-[#ff00ff] rounded-full mb-6">
                <Lock className="h-8 w-8 text-white" />
              </div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Admin Login</h2>
              <p className="text-gray-600">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.email}
                    onChange={handleInputChange}
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6a0dad] focus:border-transparent text-gray-900 placeholder-gray-500"
                    placeholder="admin@gmail.com"
                  />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.password}
                    onChange={handleInputChange}
                    className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6a0dad] focus:border-transparent text-gray-900 placeholder-gray-500"
                    placeholder="Enter your password"
                  />
                  <button
                    type="button"
               ...
               <button
                type="submit"
                disabled={isLoading}
                  className="group relative w-full flex justify-center py-3 px-4 text-sm cursor-pointer font-medium rounded-lg text-white bg-gradient-to-r from-[#6a0dad] to-[#ff00ff] hover:from-[#5a0c9d] hover:to-[#e600e6] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6a0dad]"
              >
                <div className="flex items-center gap-2">
                  {isLoading ? (
                    <>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-600">
                Need help? Contact{' '}
                <a href="mailto:support@adiyogifoundation.org" className="font-medium text-[#6a0dad] hover:text-[#ff00ff]">
                  support@adiyogifoundation.org
                </a>
              </p>
            </div>

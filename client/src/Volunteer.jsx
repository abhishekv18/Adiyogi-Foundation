...
//     setLoading(true);
//     try {
//       const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/volunteer/add`, formData, {
...
//     <>
//     <Helmet>
//   <title>Volunteers | Adiyogi Foundation</title>
//   <meta name="description" content="Join as a volunteer with Adiyogi Foundation and take part in seva, Dharma revival, and cultural initiatives." />
//   <meta name="keywords" content="Adiyogi Foundation Volunteers, Volunteer Dharma, Seva Participation, Cultural Revival" />
//   <link rel="canonical" href="https://www.adiyogifoundation.org.in/volunteers" />
...
//                <div className="relative pt-[80%] sm:pt-[85%] md:pt-[95%] lg:pt-[110%] overflow-hidden">
//   <img
//     src={volunteer.image}
//     alt={volunteer.name}
...
const Volunteer = () => {
  ...
  <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <div className="fixed bottom-4 left-4 z-40">
        <div className="relative">
          <button
            ...
            title="Admin Access"
          >
            <Shield size={20} style={{ color: '#6a0dad' }} />
          </button>
          
          {showAdminLogin && (
            <div className="absolute bottom-16 left-0 bg-white rounded-xl shadow-2xl border p-3 w-60 z-50">
              <h3 className="font-bold text-gray-900 mb-3 flex items-center">
                <Shield className="h-4 w-4 mr-2 "style={{ color: '#6a0dad' }} />
                Admin Access
              </h3>
              <Link to="/admin-login">
                <button
                  className="w-full px-4 py-2 bg-gradient-to-t from-[#6a0dad] to-[#5a0ba5] text-white rounded-lg hover:from-[#5a0ba5] hover:to-[#4a0a95] transition-all duration-300 font-medium"
                >
                  Admin Login
                </button>
              </Link>
      ...
      <div className="relative overflow-hidden py-12 md:py-20 px-4">
        ...
        <div className="absolute inset-0 z-0 bg-gradient-to-br from-purple-900/30 to-purple-800/20"></div>

        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="flex justify-center mb-4 md:mb-6">
            <div className="relative">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center animate-pulse" style={{ backgroundColor: '#6a0dad' }}>
                <Circle size={20} fill="white" className="text-white" />
              </div>
              <div className="absolute -inset-2 bg-gradient-to-r from-transparent via-purple-100 to-transparent rounded-full blur-lg opacity-50"></div>
            </div>
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4" style={{ color: '#2C2C2C' }}>
            Join the <span style={{ color: '#6a0dad' }}>Sacred Journey</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 md:space-x-8 text-center">
            <div className="flex flex-col items-center">
              <Heart size={28} style={{ color: '#6a0dad' }} className="mb-2" />
              <span className="text-sm font-medium" style={{ color: '#2C2C2C' }}>Seva & Service</span>
            </div>
            <div className="flex flex-col items-center">
              <Users size={28} style={{ color: '#6a0dad' }} className="mb-2" />
              <span className="text-sm font-medium" style={{ color: '#2C2C2C' }}>Community Unity</span>
            </div>
            <div className="flex flex-col items-center">
              <Flower2 size={28} style={{ color: '#6a0dad' }} className="mb-2" />
              <span className="text-sm font-medium" style={{ color: '#2C2C2C' }}>Spiritual Growth</span>
            </div>
          </div>
        </div>
   ...
   <div className="max-w-6xl mx-auto mt-2 px-4 py-7 md:py-12">
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-4xl font-bold mb-5" style={{ color: '#2C2C2C' }}>
            Our Dedicated <span style={{ color: '#6a0dad' }}>Volunteers</span>
          </h2>
          <p className="text-base md:text-lg max-w-2xl mx-auto" style={{ color: '#6B4B4B' }}>
         Meet the passionate individuals who dedicate their time and expertise to our spiritual mission.
          </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {volunteers.map((volunteer) => (
            <div 
              ...
              className="cursor-pointer group transition-all duration-300 hover:scale-105"
            >
              <div className="relative overflow-hidden rounded-xl shadow-md h-full" style={{ backgroundColor: '#FFFFFF' }}>
               <div className="relative pt-[80%] sm:pt-[85%] md:pt-[95%] lg:pt-[110%] overflow-hidden">
  <img
    src={volunteer.image}
    alt={volunteer.name}
  ...
  />
                ...
                <div className="p-4">
                  <h3 className="font-bold text-lg" style={{ color: '#2C2C2C' }}>{volunteer.name}</h3>
                  <p className="text-sm mb-1" style={{ color: '#6a0dad' }}>{volunteer.title}</p>
                  <p className="text-xs" style={{ color: '#6B4B4B' }}>{volunteer.role}</p>
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <span className="text-white text-sm font-medium">View Profile →</span>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          {/* Left Side - Information */}
          <div className="space-y-6 md:space-y-8">
            <div className="p-6 md:p-10 rounded-2xl shadow-lg" style={{ backgroundColor: '#FFFFFF', boxShadow: '0 4px 12px rgba(106, 13, 173, 0.15)' }}>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6" style={{ color: '#2C2C2C' }}>
                Why Volunteer with Us?
              </h2>
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-start space-x-3 md:space-x-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#F8F0FF' }}>
                    <Circle size={18} style={{ color: '#6a0dad' }} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-base md:text-lg mb-1 md:mb-2" style={{ color: '#2C2C2C' }}>Sacred Service (Seva)</h3>
                    <p className="text-xs md:text-sm leading-relaxed" style={{ color: '#6B4B4B' }}>
                ...
                <div className="flex items-start space-x-3 md:space-x-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#F8F0FF' }}>
                    <Flower size={18} style={{ color: '#6a0dad' }} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-base md:text-lg mb-1 md:mb-2" style={{ color: '#2C2C2C' }}>Spiritual Growth</h3>
                    <p className="text-xs md:text-sm leading-relaxed" style={{ color: '#6B4B4B' }}>
                ...
                <div className="flex items-start space-x-3 md:space-x-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#F8F0FF' }}>
                    <Heart size={18} style={{ color: '#6a0dad' }} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-base md:text-lg mb-1 md:mb-2" style={{ color: '#2C2C2C' }}>Divine Connection</h3>
                    <p className="text-xs md:text-sm leading-relaxed" style={{ color: '#6B4B4B' }}>
            ...
            {/* Volunteer Opportunities */}
            <div className="p-6 md:p-8 rounded-2xl shadow-lg" style={{ backgroundColor: '#FFFFFF', boxShadow: '0 4px 12px rgba(106, 13, 173, 0.15)' }}>
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6" style={{ color: '#2C2C2C' }}>
                Volunteer Opportunities
              </h3>
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <div className="text-center p-3 md:p-4 rounded-lg" style={{ backgroundColor: '#F8F0FF' }}>
                  <Users size={20} style={{ color: '#6a0dad' }} className="mx-auto mb-1 md:mb-2" />
                  <span className="text-xs md:text-sm font-medium" style={{ color: '#2C2C2C' }}>Community Outreach</span>
                </div>
                <div className="text-center p-3 md:p-4 rounded-lg" style={{ backgroundColor: '#F8F0FF' }}>
                  <Award size={20} style={{ color: '#6a0dad' }} className="mx-auto mb-1 md:mb-2" />
                  <span className="text-xs md:text-sm font-medium" style={{ color: '#2C2C2C' }}>Event Organization</span>
                </div>
                <div className="text-center p-3 md:p-4 rounded-lg" style={{ backgroundColor: '#F8F0FF' }}>
                  <Flower size={20} style={{ color: '#6a0dad' }} className="mx-auto mb-1 md:mb-2" />
                  <span className="text-xs md:text-sm font-medium" style={{ color: '#2C2C2C' }}>Temple Restoration</span>
                </div>
                <div className="text-center p-3 md:p-4 rounded-lg" style={{ backgroundColor: '#F8F0FF' }}>
                  <Circle size={20} style={{ color: '#6a0dad' }} className="mx-auto mb-1 md:mb-2" />
                  <span className="text-xs md:text-sm font-medium" style={{ color: '#2C2C2C' }}>Spiritual Programs</span>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 md:p-8 rounded-2xl shadow-lg" style={{ backgroundColor: '#FFFFFF', boxShadow: '0 4px 12px rgba(106, 13, 173, 0.15)' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <User size={16} style={{ color: '#6a0dad' }} className="absolute left-3 top-1/2 transform -translate-y-1/2" />
                  <input
                    type="text"
                    name="name"
                    required
 ...
 <div>
    ...
    <div className="relative">
      <Phone size={16} style={{ color: '#6a0dad' }} className="absolute left-3 top-1/2 transform -translate-y-1/2" />
      <input
        type="tel"
        name="phone"
        value={formData.phone}
        ...
        maxLength="10"
        className={`w-full pl-10 md:pl-12 pr-4 py-2 md:py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-200 ${
          errors.phone ? 'border-red-500' : 'border-[#F0E6FF]'
        }`}
        style={{ 
          backgroundColor: '#FFFFFF'
        }}
  ...
  <div>
    ...
    <div className="relative">
      <Mail size={16} style={{ color: '#6a0dad' }} className="absolute left-3 top-1/2 transform -translate-y-1/2" />
      <input
        type="email"
        name="email"
        value={formData.email}
        onChange={handleChange}
        className={`w-full pl-10 md:pl-12 pr-4 py-2 md:py-3 border rounded-lg focus:ring-2 focus:border-transparent transition-all duration-200 ${
          errors.email ? 'border-red-500' : 'border-[#F0E6FF]'
        }`}
        style={{ 
          backgroundColor: '#FFFFFF'
        }}
    ...
    {errors.email && (
      <p className="mt-1 text-xs text-red-500">{errors.email}</p>
              ...
              <div>
                ...
                <div className="relative">
                  <MapPin size={16} style={{ color: '#6a0dad' }} className="absolute left-3 top-1/2 transform -translate-y-1/2" />
                  <input
                    type="text"
                    name="city"
                    required
              ...
              <div>
                ...
                <div className="relative">
                  <Award size={16} style={{ color: '#6a0dad' }} className="absolute left-3 top-3 md:top-4" />
                  <textarea
                    name="skills"
                    value={formData.skills}
                    onChange={handleChange}
              ...
              <div>
                ...
                <div className="relative">
                  <MessageSquare size={16} style={{ color: '#6a0dad' }} className="absolute left-3 top-3 md:top-4" />
                  <textarea
                    name="message"
                    value={formData.message}
                    onChange={handleChange}
...
<button
  ...
  style={{ 
    ...
    boxShadow: '0 2px 8px rgba(90, 11, 165, 0.25)'
  }}
>
  {loading ? (
    <div className="flex items-center justify-center space-x-2">
...
{showModal && selectedVolunteer && (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-black bg-opacity-50 backdrop-blur-sm">
    ...
    >
      <button
        onClick={handleCloseModal}
        className="absolute top-3 right-3 z-10 p-1 rounded-full hover:bg-purple-50 transition-colors"
        style={{ color: '#6a0dad' }}
      >
        <X size={20} />
      </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="p-3 sm:p-4 md:p-5 md:col-span-2">
          ...
          <p className="text-sm sm:text-base mb-1 text-[#6a0dad]">
            {selectedVolunteer.title}
          </p>
          <p className="text-xs font-medium mb-3 text-[#6B4B4B]">
            {selectedVolunteer.role}
            ...
            <div className="flex flex-wrap gap-2">
              {selectedVolunteer.skills.map((skill, index) => (
                <span
                  key={index}
                  className="px-2 py-1 rounded-full text-[10px] font-medium"
                  style={{ backgroundColor: '#F8F0FF', color: '#6a0dad' }}
                >
                  {skill}
                </span>
              ))}
        ...
        {/* Bottom Quote Section */}
        <div className="mt-8 md:mt-16 text-center p-6 md:p-8 rounded-2xl" style={{ backgroundColor: '#FFFFFF', border: '2px solid #F0E6FF' }}>
          <FaOm size={24} style={{ color: '#6a0dad' }} className="mx-auto mb-3 md:mb-4" />
          <blockquote className="text-lg md:text-xl font-medium italic mb-3 md:mb-4" style={{ color: '#2C2C2C' }}>
            "Seva is not just service to others, but service to the divine that resides in all beings."
          </blockquote>
          <p className="text-xs md:text-sm" style={{ color: '#6a0dad' }}>
            - Ancient Vedic Wisdom
          </p>
        </div>
      </div>

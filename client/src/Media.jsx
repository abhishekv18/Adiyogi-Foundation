    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="relative bg-gradient-to-br from-purple-50 via-purple-100 to-pink-50 pt-16 sm:pt-20 md:pt-24 pb-16 sm:pb-18 md:pb-20 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#6a0dad]/20 to-[#ff00ff]/20"></div>
          <div
            className="absolute inset-0 bg-center bg-cover opacity-20 bg-scroll"
            style={{
              backgroundImage: `url('/istockphoto-1221349438-612x612.jpg')`,
        ...
        {/* Newsletter Section */}
       <div
  className="text-white py-7 sm:py-7 md:py-8 lg:py-9"
  style={{
    background: 'linear-gradient(135deg, rgba(106, 13, 173, 0.7) 0%, rgba(90, 11, 165, 0.8) 100%)',
  ...
  <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className="bg-white text-[#6a0dad] px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold transition-all duration-300 hover:bg-purple-50 hover:scale-x-105 shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap text-sm sm:text-base"
      >
        {loading ? (
          <>
            <svg

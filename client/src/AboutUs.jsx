...
></div>
  ...
  <div className="mb-6 sm:mb-8">
     ...
     <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 px-2" style={{ color: '#2C2C2C' }}>
      About Adiyogi Foundation
    </h1> 
  ...
  >
    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-10" style={{ color: '#C41E3A' }}>
      Our Sacred Vision
    </h2>
    <p
      className="text-lg sm:text-xl md:text-2xl leading-relaxed max-w-5xl mx-auto font-light px-2"
      style={{ color: '#2C2C2C' }}
    >
      Adiyogi Foundation is rooted in the timeless wisdom of Bharat, striving to awaken the sacred in
      every heart and space. Through the restoration of temples, spiritual education, and acts of

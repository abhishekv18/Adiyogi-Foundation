...
const showDeleteAdminConfirmation = (userId) => {
  ...
  const DeleteConfirmationModal = useMemo(() => {
    ...
    return (
      ...
      //       Are you sure you want to delete the blog <span className='text-sacred-crimson'>"{blogToDelete?.title}?"</span>This action cannot be undone.
      //     </p>
...
//     <div className="w-64 bg-slate-800 shadow-lg h-screen fixed left-0 top-0">
...
//       className="bg-emerald-500 text-white px-4 py-2 rounded-lg hover:bg-emerald-600 transition-colors flex items-center gap-2 shadow-lg"
//     >
...
//   </Pie>
//   <Tooltip
//     formatter={(value, name) => [`${value}`, `${name}`]} // Optional: customize text
//   />
// </PieChart>
//       </ResponsiveContainer>
//     </div>
...
//             <div key={blog.id || blog._id} className="p-6 hover:bg-slate-50 transition-colors">
//               <div className="flex items-start gap-4">
//                 <div className="relative">
//                   <img
//                     src={blog.imageUrl}
//                     alt={blog.title}
//                     className="w-24 h-24 object-cover rounded-xl shadow-md border border-slate-200"
//                   />
...
//                       <button
//                         onClick={() => navigateToEditBlog(blog)}
//                         className="p-3 text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors border border-transparent hover:border-emerald-200"
//                         title="Edit Blog"
//                       >
...
//                       <button
//                         onClick={() => showDeleteConfirmation(blog)}
//                         className="p-3 text-slate-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors border border-transparent hover:border-red-200"
//                         title="Delete Blog"
//                       >
...
//           <button
//             type='submit'
//             className="bg-emerald-500 text-white px-6 py-2 rounded-lg hover:bg-emerald-600 transition-colors shadow-lg"
//           >
...
//                       alt="Preview"
//                       className="w-40 h-40 object-cover rounded-xl border-2 border-slate-200 shadow-lg"
//                     />
//                     <button
//                       type="button"
...
//       <div className="divide-y divide-slate-200">
//         <div className="grid grid-cols-12 bg-slate-50 p-4 font-semibold text-slate-700">
...
//         {allUsers.map((user) => (
//           <div key={user._id} className="grid grid-cols-12 p-4 items-center hover:bg-slate-50 transition-colors">
//             <div className="col-span-4 font-medium text-slate-800">{user.email}</div>

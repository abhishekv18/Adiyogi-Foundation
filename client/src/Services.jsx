...
// <body>
//   <div class="header">
//     <img src="https://www.adiyogifoundation.org.in/adiyogifoundation_logo.png" alt="Adiyogi Logo" />
...
//     <>
//     <Helmet>
//   <title>Services | Adiyogi Foundation</title>
//   <meta name="description" content="Adiyogi Foundation offers spiritual services including meditation programs, yoga sessions, cultural events, and Dharma guidance." />
//   <meta name="keywords" content="Adiyogi Foundation Services, Meditation Programs, Yoga Sessions, Spiritual Guidance" />
//   <link rel="canonical" href="https://www.adiyogifoundation.org.in/services" />
...
//     style={{
//       backgroundImage: "url('/240_F_914601473_DZkb0mhvnrHvQExlOYLkXh3AfVzdEHyf.jpg')",
//     }}
//   />
...
//               <div className="text-2xl sm:text-3xl md:text-4xl font-bold">15,000+</div>
...
//             </div>
//             <div className="space-y-1 sm:space-y-2">
//               <div className="text-2xl sm:text-3xl md:text-4xl font-bold">23,000+</div>
//               <div className="text-red-100 text-sm sm:text-base md:text-lg">Consultations</div>
//             </div>
//             <div className="space-y-1 sm:space-y-2">
//               <div className="text-2xl sm:text-3xl md:text-4xl font-bold">99%</div>
...
<head>
  ...
  <style>
    ...
    .header {
      text-align: center;
      background: linear-gradient(135deg, #6a0dad 0%, #5a0ba5 100%);
      color: white;
      padding: 30px;
      border-radius: 15px;
      margin-bottom: 30px;
...
<body>
  <div class="header">
    <img src="https://www.adiyogifoundation.org.in/INSTA.jpg" alt="Adiyogi Logo" />
...
<div className="relative overflow-hidden">
  {/* Gradient Overlay */}
  <div className="absolute inset-0 bg-gradient-to-br from-purple-900/40 to-purple-800/20 z-0" />
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-14 sm:py-16 md:py-20 lg:py-24 z-10">
    <div className="text-center text-gray-800">
      {/* Icon */}
      <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full mb-6 md:mb-8 bg-[#6a0dad]">
        <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white animate-pulse" />
      </div>

      {/* Heading */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight">
        Our <span className="text-[#6a0dad] relative">Services</span>
      </h1>
                ...
                return (
                  <button
                    ...
                    className={`flex items-center space-x-2 sm:space-x-3 px-4 sm:px-6 py-2 sm:py-3 md:py-4 rounded-lg md:rounded-xl font-medium sm:font-semibold transition-all duration-300 whitespace-nowrap ${
                      isActive
                        ? `bg-gradient-to-r ${service.gradient} text-white shadow-lg`
                        : 'text-gray-600 hover:text-[#6a0dad] hover:bg-purple-50'
                    }`}
                  >
                    <IconComponent className="w-4 h-4 sm:w-5 sm:h-5" />
                    <span className="text-sm sm:text-base">{service.title}</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        {activeService && (
          <div className="space-y-8 md:space-y-12">
            {/* Service Header */}
            <div className={`bg-gradient-to-br ${activeService.lightGradient} rounded-xl md:rounded-2xl lg:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 border border-purple-100`}>
              <div className="text-center">
                <div className={`inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r ${activeService.gradient} text-white rounded-lg sm:rounded-xl md:rounded-2xl mb-4 sm:mb-5 md:mb-6`}>
                  <activeService.icon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
                </div>
                ...
                <p className="text-lg sm:text-xl text-[#6a0dad] font-semibold mb-4 sm:mb-5 md:mb-6">
                  {activeService.content.subtitle}
                </p>
                <p className="text-base sm:text-lg text-gray-700 max-w-3xl md:max-w-4xl mx-auto leading-relaxed">
                  {activeService.content.description}
              ...
              <>
                ...
                <div className="bg-white rounded-xl md:rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                    {activeService.content.whyChoose.map((reason, index) => (
                      <div key={index} className="flex items-start space-x-3 sm:space-x-4">
                        <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-[#6a0dad] flex-shrink-0 mt-0.5 sm:mt-1" />
                        <span className="text-sm sm:text-base text-gray-700 leading-relaxed">{reason}</span>
                      </div>
                    ))}
                  </div>
              ...
              <>
                ...
                {activeService.content.impactAreas && (
                  <div className="bg-white rounded-xl md:rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                      {activeService.content.impactAreas.map((area, index) => (
                        <div key={index} className={`bg-gradient-to-r ${activeService.lightGradient} p-2 sm:p-3 md:p-4 rounded-lg sm:rounded-xl text-center border border-purple-100`}>
                          <span className="text-xs sm:text-sm md:text-base font-medium sm:font-semibold text-[#6a0dad]">{area}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
                    {activeService.content.auditAreas && (
                      <div className="bg-white rounded-xl md:rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
                        ...
                        <ul className="space-y-2 sm:space-y-3">
                          {activeService.content.auditAreas.map((area, index) => (
                            <li key={index} className="flex items-center text-sm sm:text-base text-gray-700">
                              <Compass className="w-4 h-4 sm:w-5 sm:h-5 text-[#6a0dad] mr-2 sm:mr-3 flex-shrink-0" />
                              <span>{area}</span>
                            </li>
                          ))}
                        </ul>
                    ...
                    {activeService.content.activityAreas && (
                      <div className="bg-white rounded-xl md:rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:gap-3">
                          {activeService.content.activityAreas.map((area, index) => (
                            <div key={index} className={`bg-gradient-to-r ${activeService.lightGradient} px-2 sm:px-3 py-1 sm:py-2 rounded-md sm:rounded-lg text-center border border-purple-100`}>
                              <span className="text-xs sm:text-sm text-[#6a0dad] font-medium">{area}</span>
                            </div>
                          ))}
                        </div>
                      </div>
        ...
        <div
              ...
              style={{
                backgroundImage: `
                  linear-gradient(135deg, rgba(106, 13, 173, 0.6) 0%, rgba(90, 11, 165, 0.7) 100%),
                  url('/istockphoto-1455552376-612x612.webp')
                `,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
            ...
            >
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center w-full sm:w-auto">
                  <Link to="/contact" className="w-full sm:w-auto">
                    <button className="w-full sm:w-auto bg-white text-[#6a0dad] px-6 py-3 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl font-bold hover:bg-purple-50 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 hover:scale-105">
                      <span className="text-sm sm:text-base">Book Free Consultation</span>
                      <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
                    </button>
                  </Link>
                  ...
                  <button
                    onClick={downloadBrochure}
                    className="w-full sm:w-auto border-2 border-white text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl font-bold hover:bg-white hover:text-[#6a0dad] transition-all duration-300 text-sm sm:text-base"
                  >
                    Download Brochure
                  </button>
                </div>
      ...
      {/* Stats Section */}
      <div className="text-white py-12 sm:py-14 md:py-16" style={{ background: 'linear-gradient(135deg, rgba(106, 13, 173, 0.7) 0%, rgba(90, 11, 165, 1) 100%)', boxShadow: '0 8px 32px rgba(106, 13, 173, 0.15)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3 lg:mb-4">Trusted by Thousands</h3>
            <p className="text-base sm:text-lg md:text-xl text-purple-100">Our track record speaks for itself.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
            <div className="space-y-1 sm:space-y-2">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold">15,000+</div>
              <div className="text-purple-100 text-sm sm:text-base md:text-lg">Happy Clients</div>
            </div>
            <div className="space-y-1 sm:space-y-2">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold">15+</div>
              <div className="text-purple-100 text-sm sm:text-base md:text-lg">Years Experience</div>
            </div>
            <div className="space-y-1 sm:space-y-2">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold">23,000+</div>
              <div className="text-purple-100 text-sm sm:text-base md:text-lg">Consultations</div>
            </div>
            <div className="space-y-1 sm:space-y-2">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold">99%</div>
              <div className="text-purple-100 text-sm sm:text-base md:text-lg">Satisfaction Rate</div>
            </div>
          </div>
        </div>
      </div>
